...
export const SectionLeft: React.FC<{children: ReactNode}> = ({ children }) => (
  <StyledGrid.Col sm={12} lg={3}>
    {children}
  </StyledGrid.Col>
);

export const SectionRight: React.FC<{children: ReactNode}> = ({ children }) => (
  <StyledGrid.Col sm={12} lg={9}>
    {children}
  </StyledGrid.Col>
);

export const SectionCenter: React.FC<{children: ReactNode}> = ({ children }) => (
  <SectionRow>
